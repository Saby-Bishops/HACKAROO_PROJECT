...
#     chunks=text_splitter.splitter_text(text)
#     return chunks

# def get_vector_store(text_chunks):
#     embeddings=GoogleGenerativeAIEmbeddings(model="model/embeddding-001")
#     get_vector_store=FAISS.from_texts(text_chunks, embedding=embeddings)
#     get_vector_store.save_local("faiss_index")

# def get_conversational_chain():
#     prompt_template="""
#     Answer the question as detailed as possible from the proviided context, make sure to provide all the details, if the answer is not
